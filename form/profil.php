        ...
        <div class="container"> 
            ...
            <div class="box"> 
                ...
                if(isset($_POST['submit'])){ 
                    ...
                    $update = mysqli_query($conn, "UPDATE tb_profil SET admin_name = '".$nama."', username = '".$user."', admin_telp = '".$tlp."', admin_email = '".$email."', admin_address = '".$alamat."' WHERE admin_id = '".$d->admin_id."' "); 
